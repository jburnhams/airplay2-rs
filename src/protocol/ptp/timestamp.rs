...
impl PtpTimestamp {
    ...
    #[allow(
        ...
        reason = "PTP timestamps relative to epoch fit within i64 range for reasonable timeframes"
    )]
    ...
    #[allow(
        ...
        reason = "Fraction calculation is mathematically guaranteed to fit in u16"
    )]
