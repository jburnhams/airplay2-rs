...
fn test_decode_extension_bit_set() {
    // If extension bit is set (bit 4 of byte 0), current implementation sets flag but doesn't parse extension header
    // The header decode should succeed, and extension flag should be true.
    let buf = [
