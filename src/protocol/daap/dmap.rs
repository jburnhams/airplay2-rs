        ...
        match value {
            DmapValue::String(s) => {
                ...
                #[allow(
                    ...
                    reason = "String length unlikely to exceed u32::MAX in DMAP context"
                )]
            ...
            DmapValue::Int(n) => {
                ...
                if *n >= 0 && *n <= 255 {
                    ...
                    #[allow(
                        ...
                        reason = "Value explicitly checked to be within 0..=255"
                    )]
                    ...
                    #[allow(
                        clippy::cast_possible_truncation,
                        reason = "Value explicitly checked to be within i16 range"
                    )]
                    ...
                    #[allow(
                        clippy::cast_possible_truncation,
                        reason = "Value explicitly checked to be within i32 range"
                    )]
            ...
            DmapValue::Container(items) => {
                ...
                #[allow(
                    clippy::cast_possible_truncation,
                    reason = "Container size unlikely to exceed u32::MAX"
                )]
            ...
            DmapValue::Raw(data) => {
                #[allow(
                    clippy::cast_possible_truncation,
                    reason = "Raw data size unlikely to exceed u32::MAX"
                )]
...
#[allow(dead_code, reason = "Utility function for debugging and future tests")]
...
#[allow(dead_code, reason = "Error types for debugging utility")]
