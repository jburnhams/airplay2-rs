    ...
    async fn setup_session(&self) -> Result<(), AirPlayError> {
        ...
        let sdp = match self.config.audio_codec {
            ...
            AudioCodec::Aac => {
                ...
                // config=1220 (AAC-LC, 44100Hz, Stereo) is required for some receivers
                "v=0\r\no=- 0 0 IN IP4 0.0.0.0\r\ns=airplay2-rs\r\nc=IN IP4 0.0.0.0\r\nt=0 0\r\nm=audio 0 RTP/AVP 96\r\na=rtpmap:96 mpeg4-generic/44100/2\r\na=fmtp:96 mode=AAC-hbr;sizelength=13;indexlength=3;indexdeltalength=3;constantDuration=1024;config=1220\r\n".to_string()
            }
            AudioCodec::Opus => {
